# Cert-Manager
Cert-manager adds [[ssl-certs]] and certificate issuers as resource types in [[Kubernetes]] Clusters, and simplifies the process of obtaining, renewing and using those [[ssl-certs]].
